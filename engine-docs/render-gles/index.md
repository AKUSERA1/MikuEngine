...
| [gles-model-renderer.md](gles-model-renderer.md) | PMX 模型渲染：顶点格式、材质段、轮廓线、自阴影采样 |
| [gles-shadow-renderer.md](gles-shadow-renderer.md) | 自阴影 Z 图 + 床影：紧视锥 / texel snapping / 多风格 |
| [gles-support.md](gles-support.md) | GlesTextureLibrary · PmxFileResolver · GlesSkinMatricesBuffer · GlesDebugOverlay |
